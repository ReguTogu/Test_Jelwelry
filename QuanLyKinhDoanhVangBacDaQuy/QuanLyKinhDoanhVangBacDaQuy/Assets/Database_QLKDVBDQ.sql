...
INSERT INTO PHIEUDICHVU ( MaKhachHang, MaNhanVien, MaDichVu, SoLuong, DonGia, TraTruoc, TinhTrang, NgayBan)
VALUES
    (1, 3, 1, 3, 400000, 0, N'Chưa thanh toán', '2024-08-11'),
    (2, 2, 2, 2, 400000, 200000, N'Hoàn thành', '2024-08-05'),
    (3, 1, 3, 4, 200000, 100000, N'Đang xử lý', '2024-10-3'),
    (4, 3, 4, 7, 1000000, 500000, N'Hoàn thành', '2024-03-09');
